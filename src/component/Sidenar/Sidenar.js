      ...
      {isBrowser
        ...
        <>
          <div className="DAT_SidenarMobile">
            {data["Dashboard"].link === "none"
              ...
              >
                <div className="DAT_SidenarMobile_Item_Icon">
                  {sidebartab.value === "Dashboard" ? <ion-icon name="home"></ion-icon> : <ion-icon name="home-outline"></ion-icon>}
                </div>
                <span>
              ...
              :
              <Link className="DAT_SidenarMobile_Item"
            ...
            >
              <div className="DAT_SidenarMobile_Item_Icon">
                {sidebartab.value === "Analytics" ? <ion-icon name="document-text"></ion-icon> : <ion-icon name="document-text-outline"></ion-icon>}
              </div>
              <span>
            ...
            >
              <div className="DAT_SidenarMobile_Item_Icon">
                {sidebartab.value === "Setting" ? <ion-icon name="settings"></ion-icon> : <ion-icon name="settings-outline"></ion-icon>}
              </div>
              <span>
