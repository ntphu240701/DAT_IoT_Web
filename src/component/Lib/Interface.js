...
export default function Interface(props) {
  ...
  const [signalbar, setSignalbar] = useState("0");
  ...
  useEffect(
    function () {
      ...
      var loaddata = async () => {
        ...
        if (res.ret === 0) {
          setInvt(res.data);
          // console.log(res.data.csq)
          if (res.data?.csq) {
            if (res.data.enabled === "1") {
              if (res.data.csq < 10) {
                setSignalbar("1");
              } else if (res.data.csq >= 10 && res.data.csq < 15) {
                setSignalbar("2");
              } else if (res.data.csq >= 15 && res.data.csq < 20) {
                setSignalbar("3");
              } else if (res.data.csq >= 20) {
                setSignalbar("4");
              } else {
                setSignalbar("0");
              }
      ...
      if (step === 0) {
        ...
        console.log(`Full Register of ${props.sn}`, invt);
        try {
  ...
  useEffect(() => {
    ...
    if (window.innerWidth >= 1500) {
      ...
      svgview.style.width =
        svgcontainner.offsetWidth / (card.offsetWidth / 1500);
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []);
        ...
        {show.value ? (
          <>
            ...
            <div style={{ display: "flex" , alignItems:"flex-end"}}>
              <div
                className="DAT_Tool_Connect"
                style={{ bottom: "10px", left: "10px" }}
              >
                <img
                  alt=""
                  style={{ width: "20px" }}
                  src={`/dat_icon/signal_${signalbar}.png`}
                ></img>
                {/* {(invt !== undefined)
                                ? (invt['enabled'] === '1')
                                    ? <img alt="" style={{ width: "20px" }} src="/dat_icon/signal_3.png"></img>
                                    : <img alt="" style={{ width: "20px" }} src="/dat_icon/signal_0.png"></img>
                                : <img alt="" style={{ width: "20px" }} src="/dat_icon/signal_0.png"></img>
                            } */}
              </div>
              <div
